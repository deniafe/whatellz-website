...
export const Email = () => {
  ...
  const fetchPaymentLink = async (event: React.SyntheticEvent) => {
    event.preventDefault();
  
    if (!email) return setErrorMessage('You need to enter an email to proceed');
  
    if (!isValidEmail(email)) return setErrorMessage('Email not valid! Try again');
  ...
  useEffect(() => {
    ...
    // Access the fragment identifier (the part after the "#")
    var fragment = url.hash;

    // Remove the "#" from the fragment to get just the word "starter"
    var word = fragment.substring(1);

    console.log(word); // Output: starter


    // Capitalize the first letter
    const capitalizedPlan = word.charAt(0).toUpperCase() + word.slice(1);
          ...
          <div className="md:mx-[4rem] flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[24px] md:text-[32px] font-bold uppercase text-gray-800 ">
                  Enter Your Details
                </h2>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form onSubmit={fetchPaymentLink}>
                  ...
                  <div>
                    ...
                    >
                     {loading ? (<span className="animate-pulse" >Loading ...</span>) : 'Checkout'}
                    </button>
                  </div>
                </form>
                <div>
