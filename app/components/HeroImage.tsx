...
export const HeroImage = () => {
  ...
  return (
    <div id="hero-image" ref={ref} className="px-[1rem] mb-[16rem] pt-[8rem] md:mb-0 md:pt-0 md:mt-[6rem] md:px-[4rem] [perspective:2000px] w-screen">
      ...
      <div
        className={`relative rounded-lg border border-transparent-white bg-white bg-opacity-[0.01] bg-hero-gradient md:mx-[6rem] ${
      ...
      >
        <div className="absolute top-0 left-0 z-20 h-full w-full">
          {lines.map((line) => (
            <span
              ...
              className={`absolute top-0 block h-[1px] w-[10rem] bg-glow-lines ${
        ...
        <img
          className={`relative z-10 transition-opacity delay-[680ms] ${
